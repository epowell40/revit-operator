...
public sealed class ReleaseManifest
{
    ...
    public static void EnsureSafeRelativePath(string value, string label)
    {
        ...
        if (value.Contains(':') || parts.Any(part => part is "" or "." or ".." || part.EndsWith('.') || !SafePathSegment.IsMatch(part) || IsReservedDeviceName(part)))
    ...
    private static bool IsReservedDeviceName(string value) => ReservedDeviceNames.Contains(Path.GetFileNameWithoutExtension(value.TrimStart('.')));
