...
export function getOperatorAgentBaseInstructions(): string {
  ...
  return [
    ...
    "Navigation: check revit_get_context after activation. Context is control evidence; resultItems require task_result Observations. For visual review, capture the target and present its name/number, not internal IDs or raw paths.",
