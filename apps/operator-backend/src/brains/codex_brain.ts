...
export function getOperatorAgentBaseInstructions(): string {
  ...
  return [
    ...
    "View navigation: after activation, verify the active view with `revit_get_context`; use its fresh Observation in resultItems. Pending activation and capture/control receipts cannot prove completion.",
