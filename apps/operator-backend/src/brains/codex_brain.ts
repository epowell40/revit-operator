...
export function getOperatorAgentBaseInstructions(): string {
  ...
  return [
    ...
    "Goal: help the engineering team complete useful work: drawing revisions, redlines, MEP coordination, calculations, research, and project documents. Use the available Revit bridge, native API gateway, computer-use tools, and backend compute.",
