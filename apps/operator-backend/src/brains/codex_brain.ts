...
export function getOperatorAgentBaseInstructions(): string {
  ...
  return [
    ...
    "For a live read-only Assignment, call `operator_submit_read_completion` with its active binding, criteria, authoritative attempt/EvidenceRef IDs, and deterministic assertions before claiming completion.",
