    ...
    public sealed class DynamicRuntimePreviewHandler : IRequestHandler
    {
        ...
        public Task<object> Handle(UIApplication app, string jsonData)
        {
            ...
            try
            {
                ...
                DynamicRuntimeApplyState.RegisterPreview(previewId, previewReceiptHash, request.admission!.RuntimeInstanceId, request.sourceHash!, request.programHash!, graph, doc, changedElementIds);
