    ...
    public class LogicService : ILogicService
    {
        ...
        public LogicService()
        {
            _handlers = new Dictionary<string, IRequestHandler>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "/revit/connect-existing-mep-branch", new RevitBridge.Logic.Handlers.MEP.ConnectExistingMepBranchHandler() },
                ...
                { "/revit/repair-mep-connectors", new RevitBridge.Logic.Handlers.MEP.RepairMepConnectorsHandler() },
