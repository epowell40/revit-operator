...
public sealed class RevitHostCapabilityManifest
{
    ...
    private static readonly string[] RequiredYears = ["2023", "2024", "2025", "2026", "2027"];
    ...
    public void Validate()
    {
        ...
        if (!RequiredYears.SequenceEqual(years.OrderBy(value => value, StringComparer.Ordinal)))
            throw new InvalidDataException("The trusted host-capability manifest must contain exactly Revit 2023, 2024, 2025, 2026, and 2027.");
    }
...
public sealed class RevitHostCapability
{
    ...
    {
        if (RevitYear is not ("2023" or "2024" or "2025" or "2026" or "2027")) throw new InvalidDataException($"Unsupported Revit host year '{RevitYear}'.");
        var expectedFramework = RevitYear == "2027" ? "net10.0-windows" : RevitYear is "2025" or "2026" ? "net8.0-windows" : "net48";
