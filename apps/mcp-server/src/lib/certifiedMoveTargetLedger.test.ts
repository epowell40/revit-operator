...
const observation = { observationId: "frame-1", viewId: 42, items: [
  { elementId: 17, sourceScopedId: "host:17", groundingStatus: "anchored", pinned: false, groupId: null, groupIdReadSucceeded: true, category: "Mechanical Equipment", familyName: "Pump", typeName: "P-1", orientation: { locationKind: "point", locationPoint: { x: 1, y: 2, z: 3 } } },
  ...
  { elementId: 20, sourceScopedId: "host:20", groundingStatus: "anchored", pinned: true, groupId: null, groupIdReadSucceeded: true, orientation: { locationKind: "point", locationPoint: { x: 4, y: 5, z: 6 } } },
  { elementId: 21, sourceScopedId: "host:21", groundingStatus: "anchored", pinned: false, groupId: 99, groupIdReadSucceeded: true, orientation: { locationKind: "point", locationPoint: { x: 4, y: 5, z: 6 } } },
  { elementId: 22, sourceScopedId: "host:22", groundingStatus: "anchored", pinned: false, groupId: null, groupIdReadSucceeded: false, orientation: { locationKind: "point", locationPoint: { x: 4, y: 5, z: 6 } } },
  { elementId: 23, sourceScopedId: "host:23", groundingStatus: "anchored", pinned: false, groupId: null, groupIdReadSucceeded: true, group_id: null, orientation: { locationKind: "point", locationPoint: { x: 4, y: 5, z: 6 } } }
] };
...
test("mints exact host point target bindings only from a native observation plus current context", () => {
  ...
  assert.deepEqual(listCertifiedMoveTargets("frame-1"), [{
    ...
    category: "Mechanical Equipment", familyName: "Pump", typeName: "P-1"
  }]);
